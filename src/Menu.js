...
class Menu extends Component {
        ...
        return(
            <div className="Menu" style={this._getPositionStyle(event)}>
                <label  className="Menu-Command-Label"> Add Attachment
                    <input type='file' className="Menu-Command" onChange={(e) => this.fileChangeHander(e)}></input>
                </label>
                <br />
                <label  className="Menu-Command-Label"> Add Child
                    <input type='button' className="Menu-Command" onClick={(e) => this.props.addChild(this.props.leafdata.id)}></input>
                </label>
                <br />
                <label  className="Menu-Command-Label"> Add SIbling
                    <input type='button' className="Menu-Command" onClick={(e) => this.props.addSibling(this.props.leafdata.id)}></input>
                </label>
            </div>
        )
    }
    ...
    return (
        <div>
            <label  className="Menu-Command-Label"> 三
                <input type='button' className="Menu-Command" onClick={(e) => {this.setState({modal : this._switchModal(e)}) }}></input>
            </label>
            {this.state.modal}
        </div>
    );
