...
describe('A suite', function() {
    ...
    it('should calculate numbers properly', function(){
        ...
        const wrapper=mount(<PreviewList leafdata={data0}/>);
        //console.log(wrapper.debug());
        expect(wrapper.find(sel('val-0-0')).at(0).text()).toEqual(expect.stringContaining("first level"));
        expect(wrapper.find(sel('val-0-1')).at(0).text()).toEqual('');

        expect(wrapper.find(sel('val-1-0')).at(0).text()).toEqual(expect.stringContaining("second level"));
        expect(wrapper.find(sel('val-1-1')).at(0).text()).toEqual('');


        expect(wrapper.find(sel('val-2-0')).at(0).text()).toEqual(expect.stringContaining("third level"));
        expect(wrapper.find(sel('val-2-1')).at(0).text()).toEqual('');


        expect(wrapper.find(sel('val-3-0')).at(0).text()).toEqual(expect.stringContaining("fourth level"));
        expect(wrapper.find(sel('val-3-1')).at(0).text()).toEqual('');


        expect(wrapper.find(sel('val-4-0')).at(0).text()).toEqual(expect.stringContaining("fifth level"));
