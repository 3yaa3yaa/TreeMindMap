...
describe("A suite", function () {
  ...
  it("should calculate numbers properly", function () {
    ...
    //console.log(wrapper.debug());
    expect(
      wrapper.find(".PreviewSentence-Paragraph .description").at(0).text()
    ).toEqual(expect.stringContaining("61.5"));
    expect(
      wrapper.find(".PreviewSentence-Paragraph .description").at(1).text()
    ).toEqual(expect.stringContaining("3"));
    expect(
      wrapper.find(".PreviewSentence-Paragraph .description").at(2).text()
    ).toEqual(expect.stringContaining("20.5"));
    expect(
      wrapper.find(".PreviewSentence-Paragraph .description").at(3).text()
    ).toEqual(expect.stringContaining("10.5"));
    expect(
      wrapper.find(".PreviewSentence-Paragraph .description").at(4).text()
    ).toEqual(expect.stringContaining("20.5"));
    expect(
      wrapper.find(".PreviewSentence-Paragraph .description").at(5).text()
    ).toEqual(expect.stringContaining("30.5"));
  });
